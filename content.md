...
The fact that Markdown is plain text means that it can be edited with any text editor, and it is also version control friendly. This makes it easy to collaborate on documents and track changes over time.

The plaintext nature of Markdown also means it is easy to parse and contains no superfluous formatting information. This makes it a natural language to use for providing information to AI models, and many AI models will use Markdown as a part of their output formatting.